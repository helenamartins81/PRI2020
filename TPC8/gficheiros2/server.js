...
//server static files
//ficheiros estáticos vão estar na pasta public
...
app.post('/files', upload.array('myFile', 15), function(req, res){
    ...
    req.files.forEach(reqImage => {
        ...
        let quarantinePath = __dirname + '/' + reqImage.path 
        let newPath = __dirname + '/public/fileStore/' + reqImage.originalname
...
app.listen(7701,() => console.log('Servidor está a escuta na porta 7701...'))